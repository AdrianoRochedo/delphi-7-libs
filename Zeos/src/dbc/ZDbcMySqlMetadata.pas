...
uses Math, ZDbcUtils, ZCollections, ZDbcMySqlUtils, ZMySqlToken,
  ZMySqlAnalyser;
...
constructor TZMySQLDatabaseMetadata.Create(Connection: IZConnection;
...
function TZMySQLDatabaseMetadata.SupportsDataManipulationTransactionsOnly:
  Boolean;
begin
  case Connection.GetTransactionIsolation of
...
begin
  ...
  TableNameLength := 0;
  TableNameList := TZStringList.Create;
  TypeInfoList := TZStringList.Create;
  ...
  try
    ...
    begin
      ...
      begin
        ...
        TargetResultSet.UpdateString(13, ResultSet.GetStringByName('Default'));
...
begin
  if Table = '' then
    raise Exception.Create('Table not specified'); //CHANGE IT!
...
begin
  ...
  KeyList := TZStringList.Create;
  CommentList := TZStringList.Create;
