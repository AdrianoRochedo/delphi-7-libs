...
uses Classes, SysUtils, ZDbcIntfs, ZParseIntfs, ZCompatibility;
...
type
  ...
  private
    ...
    FClosed: Boolean;
  protected
    constructor Create(HostName: string; Port: Integer; Database: string;
    ...
    property _ReadOnly: Boolean read FReadOnly write FReadOnly;
  ...
  public
    ...
    function CreateStatement: IZStatement; virtual;
    function PrepareStatement(SQL: string): IZPreparedStatement; virtual;
    function PrepareCall(SQL: string): IZCallableStatement; virtual;
    ...
    function GetMetadata: IZDatabaseMetadata; virtual;
  ...
  public
    ...
    procedure Listen(Event: string); virtual;
    procedure Unlisten(Event: string); virtual;
...
constructor TZAbstractConnection.Create(HostName: string; Port: Integer;
...
destructor TZAbstractNotification.Destroy;
begin
  FConnection := nil;
  inherited Destroy;
end;
...
{**
  ...
  @param Event a database event name.
}
procedure TZAbstractNotification.Listen(Event: string);
begin
  FEventName := Event;
end;
...
procedure TZAbstractNotification.Unlisten(Event: string);
begin
  FEventName := '';
end;
...
{**
  ...
  @param Event a notification string to be send.
}
procedure TZAbstractNotification.DoNotify(Event: string);
begin
end;
