...
type
  ...
  protected
    ...
    property ColumnsInfo: TZCollection read FColumnsInfo;
    property Metadata: IZResultSetMetadata read FMetadata;
  ...
  public
    ...
    function GetLong(ColumnIndex: Integer): LongInt; virtual;
    function GetFloat(ColumnIndex: Integer): Single; virtual;
    function GetDouble(ColumnIndex: Integer): Double; virtual;
    function GetBigDecimal(ColumnIndex: Integer): Int64; virtual;
    ...
    function GetLongByName(ColumnName: string): LongInt; virtual;
    function GetFloatByName(ColumnName: string): Single; virtual;
    function GetDoubleByName(ColumnName: string): Double; virtual;
    function GetBigDecimalByName(ColumnName: string): Int64; virtual;
    ...
    procedure UpdateLong(ColumnIndex: Integer; Value: LongInt); virtual;
    ...
    procedure UpdateBigDecimal(ColumnIndex: Integer; Value: Int64); virtual;
    ...
    procedure UpdateLongByName(ColumnName: string; Value: LongInt); virtual;
    ...
    procedure UpdateBigDecimalByName(ColumnName: string; Value: Int64); virtual;
...
uses ZDbcUtils, ZDbcResultSetMetadata;
...
begin
  ...
  begin
    ...
    FMetadata := CreateResultSetMetadata(SQL, FColumnsInfo);
    FMaxRows := 0;
  end
  else
  begin
...
begin
  raise EZSQLException.Create('Operation is not allowed in FORWARD ONLY mode.');
end;
...
begin
  raise EZSQLException.Create('Operation is not allowed in READ ONLY mode.');
end;
...
begin
  if FClosed then
    raise EZSQLException.Create('Cannot perform operation on closed result set.');
end;
...
begin
  CheckClosed;
  if (FMetadata = nil) or (ColumnIndex <= 0)
    or (ColumnIndex > FMetadata.GetColumnCount) then
  begin
    raise EZSQLException.Create(
      Format('Column with index %d is not accessable.', [ColumnIndex]));
  end;

  InitialType := FMetadata.GetColumnType(ColumnIndex);
...
function TZAbstractResultSet.CreateResultSetMetadata(SQL: string;
...
begin
  ...
  Result := TZAbstractResultSetMetadata.Create(Metadata, SQL, ColumnsInfo);
end;
...
function TZAbstractResultSet.GetLong(ColumnIndex: Integer): LongInt;
begin
{$IFNDEF DISABLE_CHECKING}
...
function TZAbstractResultSet.GetBigDecimal(ColumnIndex: Integer): Int64;
begin
{$IFNDEF DISABLE_CHECKING}
...
begin
  Result := IsNull(FindColumn(ColumnName));
end;
...
begin
  Result := GetPChar(FindColumn(ColumnName));
end;
...
begin
  Result := GetString(FindColumn(ColumnName));
end;
...
function TZAbstractResultSet.GetUnicodeStringByName(ColumnName: string):
  WideString;
begin
  Result := GetUnicodeString(FindColumn(ColumnName));
end;
...
begin
  Result := GetBoolean(FindColumn(ColumnName));
end;
...
begin
  Result := GetByte(FindColumn(ColumnName));
end;
...
begin
  Result := GetShort(FindColumn(ColumnName));
end;
...
begin
  Result := GetInt(FindColumn(ColumnName));
end;
...
function TZAbstractResultSet.GetLongByName(ColumnName: string): LongInt;
begin
  Result := GetLong(FindColumn(ColumnName));
end;
...
begin
  Result := GetFloat(FindColumn(ColumnName));
end;
...
begin
  Result := GetDouble(FindColumn(ColumnName));
end;
...
function TZAbstractResultSet.GetBigDecimalByName(ColumnName: string): Int64;
begin
  Result := GetBigDecimal(FindColumn(ColumnName));
end;
...
begin
  Result := GetBytes(FindColumn(ColumnName));
end;
...
begin
  Result := GetDate(FindColumn(ColumnName));
end;
...
begin
  Result := GetTime(FindColumn(ColumnName));
end;
...
begin
  Result := GetTimestamp(FindColumn(ColumnName));
end;
...
begin
  Result := GetAsciiStream(FindColumn(ColumnName));
end;
...
begin
  Result := GetUnicodeStream(FindColumn(ColumnName));
end;
...
begin
  Result := GetBinaryStream(FindColumn(ColumnName));
end;
...
begin
  Result := GetBlob(FindColumn(ColumnName));
end;
...
begin
  ...
  for I := 1 to Metadata.GetColumnCount do
  begin
    if UpperCase(Metadata.GetColumnLabel(I)) = UpperCase(ColumnName) then
    begin
      Result := I;
      Exit;
    end;
  ...
  raise EZSQLException.Create(
    Format('Column with name %s was not found.', [ColumnName]));
end;
...
procedure TZAbstractResultSet.UpdateLong(ColumnIndex: Integer; Value: LongInt);
begin
  RaiseReadOnlyException;
end;
...
procedure TZAbstractResultSet.UpdateBigDecimal(ColumnIndex: Integer; Value: Int64);
begin
  RaiseReadOnlyException;
end;
...
procedure TZAbstractResultSet.UpdatePCharByName(ColumnName: string;
  Value: PChar);
begin
  UpdatePChar(FindColumn(ColumnName), Value);
end;
...
procedure TZAbstractResultSet.UpdateUnicodeStringByName(ColumnName: string;
  Value: WideString);
begin
  UpdateUnicodeString(FindColumn(ColumnName), Value);
end;
...
procedure TZAbstractResultSet.UpdateAsciiStreamByName(ColumnName: string;
  Value: TStream);
begin
  UpdateAsciiStream(FindColumn(ColumnName), Value);
end;
...
procedure TZAbstractResultSet.UpdateBinaryStreamByName(ColumnName: string;
  Value: TStream);
begin
  UpdateBinaryStream(FindColumn(ColumnName), Value);
end;
...
procedure TZAbstractResultSet.UpdateUnicodeStreamByName(ColumnName: string;
  Value: TStream);
begin
  UpdateUnicodeStream(FindColumn(ColumnName), Value);
end;
...
begin
  ...
  if Assigned(FBlobData) then
    Result.WriteBuffer(FBlobData^, FBlobSize);
  Result.Position := 0;
end;
