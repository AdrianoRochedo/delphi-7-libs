...
// File generated on 10/2/2002 11:58:31 from Type Library described below.
...
//   Hint: Parameter 'type' of IXMLDOMSchemaCollection2.getType changed to 'type_'
//   Hint: Parameter 'type' of ISchemaType.baseType changed to 'type_'
//   Hint: Member 'type' of 'ISchemaDeclaration' changed to 'type_'
//   Hint: Parameter 'type' of ISchemaDeclaration.type changed to 'type_'
...
uses ActiveX, Classes, Graphics, OleServer, StdVCL, Variants, Windows, xmldom, msxmldom;
...
const
  SMSXML4 = 'MSXML4';  { Do not localize }
  ...
  IID_IXMLDOMSchemaCollection2: TGUID = '{373984CA-B845-449B-91E7-45AC83036ADE}';
  IID_ISchemaType: TGUID = '{1535D676-3245-4A79-AF85-CD7A46AA344F}';
  IID_ISchemaDeclaration: TGUID = '{3AC991CD-35F5-4021-AA64-DFCD7CE0F26F}';
  ...
  IID_IMXNamespaceManager: TGUID = '{C90352F5-643C-4FBC-BB23-E996EB2D51FD}';
  ...
  CLASS_SAXXMLReader40: TGUID = '{88D969C7-F192-11D4-A65F-0040963251E5}';
...
// *********************************************************************//
  ...
  ISchemaDeclaration = interface;
  ISchemaDeclarationDisp = dispinterface;
  ...
  IMXNamespaceManagerDisp = dispinterface;
...
// *********************************************************************//
  ...
  XMLSchemaCache40 = IXMLDOMSchemaCollection;
  ...
  ServerXMLHTTP40 = IServerXMLHTTPRequest;
  ...
  MXNamespaceManager = IMXNamespaceManager;
  MXNamespaceManager40 = IMXNamespaceManager;
...
// *********************************************************************//
  IXMLDOMImplementationDisp = dispinterface
    ['{2933BF8F-7B36-11D2-B20E-00C04F983E60}']
    function  hasFeature(const feature: WideString; const version: WideString): WordBool; dispid 157;
  end;
...
// *********************************************************************//
  IXMLDOMParseErrorDisp = dispinterface
    ...
    property url: WideString readonly dispid 191;
    property reason: WideString readonly dispid 192;
    property srcText: WideString readonly dispid 193;
    property line: Integer readonly dispid 194;
    property linepos: Integer readonly dispid 195;
    property filepos: Integer readonly dispid 196;
  end;
...
// *********************************************************************//
  IXMLDOMDocument2Disp = dispinterface
    ['{2933BF95-7B36-11D2-B20E-00C04F983E60}']
    property namespaces: IXMLDOMSchemaCollection readonly dispid 213;
    property schemas: OleVariant dispid 214;
    function  validate: IXMLDOMParseError; dispid 215;
    procedure setProperty(const name: WideString; value: OleVariant); dispid 216;
    function  getProperty(const name: WideString): OleVariant; dispid 217;
    property doctype: IXMLDOMDocumentType readonly dispid 38;
    property implementation_: IXMLDOMImplementation readonly dispid 39;
    property documentElement: IXMLDOMElement dispid 40;
    function  createElement(const tagName: WideString): IXMLDOMElement; dispid 41;
...
// Flags:     (4560) Hidden Dual NonExtensible OleAutomation Dispatchable
// GUID:      {373984CA-B845-449B-91E7-45AC83036ADE}
// *********************************************************************//
  IXMLDOMSchemaCollection2 = interface(IXMLDOMSchemaCollection)
    ['{373984CA-B845-449B-91E7-45AC83036ADE}']
    function  getType(const strName: WideString; const namespaceURI: WideString): ISchemaType; safecall;
    function  getDecl(const strName: WideString; const namespaceURI: WideString; bElement: WordBool): ISchemaDeclaration; safecall;
  end;
...
// *********************************************************************//
  IXMLDOMSchemaCollection2Disp = dispinterface
    ['{373984CA-B845-449B-91E7-45AC83036ADE}']
    function  getType(const strName: WideString; const namespaceURI: WideString): ISchemaType; dispid 9;
    function  getDecl(const strName: WideString; const namespaceURI: WideString; bElement: WordBool): ISchemaDeclaration; dispid 10;
    procedure add(const namespaceURI: WideString; var_: OleVariant); dispid 3;
    function  get(const namespaceURI: WideString): IXMLDOMNode; dispid 4;
    procedure remove(const namespaceURI: WideString); dispid 5;
    property length: Integer readonly dispid 6;
...
// Flags:     (4544) Dual NonExtensible OleAutomation Dispatchable
// GUID:      {1535D676-3245-4A79-AF85-CD7A46AA344F}
// *********************************************************************//
  ISchemaType = interface(IXMLDOMElement)
    ['{1535D676-3245-4A79-AF85-CD7A46AA344F}']
    function  Get_typeName: WideString; safecall;
    function  Get_typeNamespaceURI: WideString; safecall;
    function  Get_baseType: ISchemaType; safecall;
    function  Get_elementDecls: IXMLDOMNamedNodeMap; safecall;
    function  Get_attributeDecls: IXMLDOMNamedNodeMap; safecall;
    property typeName: WideString read Get_typeName;
    property typeNamespaceURI: WideString read Get_typeNamespaceURI;
    property baseType: ISchemaType read Get_baseType;
    property elementDecls: IXMLDOMNamedNodeMap read Get_elementDecls;
    property attributeDecls: IXMLDOMNamedNodeMap read Get_attributeDecls;
  end;
...
// *********************************************************************//
  ISchemaTypeDisp = dispinterface
    ['{1535D676-3245-4A79-AF85-CD7A46AA344F}']
    property typeName: WideString readonly dispid 145;
    property typeNamespaceURI: WideString readonly dispid 146;
    property baseType: ISchemaType readonly dispid 147;
    property elementDecls: IXMLDOMNamedNodeMap readonly dispid 148;
    property attributeDecls: IXMLDOMNamedNodeMap readonly dispid 149;
    property tagName: WideString readonly dispid 97;
    function  getAttribute(const name: WideString): OleVariant; dispid 99;
    procedure setAttribute(const name: WideString; value: OleVariant); dispid 100;
    procedure removeAttribute(const name: WideString); dispid 101;
...
// *********************************************************************//
// Interface: ISchemaDeclaration
// Flags:     (4544) Dual NonExtensible OleAutomation Dispatchable
// GUID:      {3AC991CD-35F5-4021-AA64-DFCD7CE0F26F}
// *********************************************************************//
  ISchemaDeclaration = interface(IXMLDOMElement)
    ['{3AC991CD-35F5-4021-AA64-DFCD7CE0F26F}']
    function  Get_declName: WideString; safecall;
    function  Get_declNamespaceURI: WideString; safecall;
    function  Get_type_: ISchemaType; safecall;
    property declName: WideString read Get_declName;
    property declNamespaceURI: WideString read Get_declNamespaceURI;
    property type_: ISchemaType read Get_type_;
  end;

// *********************************************************************//
// DispIntf:  ISchemaDeclarationDisp
// Flags:     (4544) Dual NonExtensible OleAutomation Dispatchable
// GUID:      {3AC991CD-35F5-4021-AA64-DFCD7CE0F26F}
// *********************************************************************//
  ISchemaDeclarationDisp = dispinterface
    ['{3AC991CD-35F5-4021-AA64-DFCD7CE0F26F}']
    property declName: WideString readonly dispid 152;
    property declNamespaceURI: WideString readonly dispid 153;
    property type_: ISchemaType readonly dispid 154;
    property tagName: WideString readonly dispid 97;
    function  getAttribute(const name: WideString): OleVariant; dispid 99;
    procedure setAttribute(const name: WideString; value: OleVariant); dispid 100;
    procedure removeAttribute(const name: WideString); dispid 101;
...
// *********************************************************************//
  IXTLRuntimeDisp = dispinterface
    ['{3EFAA425-272F-11D2-836F-0000F87A7782}']
    function  uniqueID(const pNode: IXMLDOMNode): Integer; dispid 199;
    function  depth(const pNode: IXMLDOMNode): Integer; dispid 200;
    function  childNumber(const pNode: IXMLDOMNode): Integer; dispid 201;
    function  ancestorChildNumber(const bstrNodeName: WideString; const pNode: IXMLDOMNode): Integer; dispid 202;
    function  absoluteChildNumber(const pNode: IXMLDOMNode): Integer; dispid 203;
    function  formatIndex(lIndex: Integer; const bstrFormat: WideString): WideString; dispid 204;
    function  formatNumber(dblNumber: Double; const bstrFormat: WideString): WideString; dispid 205;
    function  formatDate(varDate: OleVariant; const bstrFormat: WideString; 
                         varDestLocale: OleVariant): WideString; dispid 206;
    function  formatTime(varTime: OleVariant; const bstrFormat: WideString; 
                         varDestLocale: OleVariant): WideString; dispid 207;
    property nodeName: WideString readonly dispid 2;
    property nodeValue: OleVariant dispid 3;
    property nodeType: DOMNodeType readonly dispid 4;
    property parentNode: IXMLDOMNode readonly dispid 6;
...
// *********************************************************************//
  XMLDOMDocumentEvents = dispinterface
    ...
    procedure ondataavailable; dispid 210;
...
// *********************************************************************//
  IMXNamespacePrefixesDisp = dispinterface
    ...
    property length: Integer readonly dispid 1413;
    property _newEnum: IUnknown readonly dispid -4;
  end;
...
// *********************************************************************//
  IMXNamespaceManager = interface(IDispatch)
    ...
    procedure _getDeclaredPrefix(nIndex: Integer; var pwchPrefix: Word; var pcchPrefix: SYSINT); safecall;
    procedure _getPrefix(var pwszNamespaceURI: Word; nIndex: Integer; var pwchPrefix: Word; 
                         var pcchPrefix: SYSINT); safecall;
    procedure _getURI(var pwchPrefix: Word; const pContextNode: IXMLDOMNode; var pwchUri: Word; 
                      var pcchUri: SYSINT); safecall;
    property allowOverride: WordBool read Get_allowOverride write Set_allowOverride;
  end;

// *********************************************************************//
// DispIntf:  IMXNamespaceManagerDisp
// Flags:     (4544) Dual NonExtensible OleAutomation Dispatchable
// GUID:      {C90352F5-643C-4FBC-BB23-E996EB2D51FD}
// *********************************************************************//
  IMXNamespaceManagerDisp = dispinterface
    ['{C90352F5-643C-4FBC-BB23-E996EB2D51FD}']
    property allowOverride: WordBool dispid 1403;
    procedure reset; dispid 1404;
    procedure pushContext; dispid 1405;
    procedure pushNodeContext(const contextNode: IXMLDOMNode; fDeep: WordBool); dispid 1406;
    procedure popContext; dispid 1407;
    procedure declarePrefix(const prefix: WideString; const namespaceURI: WideString); dispid 1408;
    function  getDeclaredPrefixes: IMXNamespacePrefixes; dispid 1409;
    function  getPrefixes(const namespaceURI: WideString): IMXNamespacePrefixes; dispid 1410;
    function  getURI(const prefix: WideString): OleVariant; dispid 1411;
    function  getURIFromNode(const strPrefix: WideString; const contextNode: IXMLDOMNode): OleVariant; dispid 1412;
    procedure _getDeclaredPrefix(nIndex: Integer; var pwchPrefix: {??Word}OleVariant; 
                                 var pcchPrefix: SYSINT); dispid 1610743819;
    procedure _getPrefix(var pwszNamespaceURI: {??Word}OleVariant; nIndex: Integer; 
                         var pwchPrefix: {??Word}OleVariant; var pcchPrefix: SYSINT); dispid 1610743820;
    procedure _getURI(var pwchPrefix: {??Word}OleVariant; const pContextNode: IXMLDOMNode; 
                      var pwchUri: {??Word}OleVariant; var pcchUri: SYSINT); dispid 1610743821;
  end;
...
// create instances of the default interface IMXNamespaceManager exposed by              
// the CoClass MXNamespaceManager. The functions are intended to be used by             
// clients wishing to automate the CoClass objects exposed by the         
// server of this typelibrary.                                            
// *********************************************************************//
  CoMXNamespaceManager = class
    class function Create: IMXNamespaceManager;
    class function CreateRemote(const MachineName: string): IMXNamespaceManager;
  end;
...
var
  MSXML4_DOM: TMSDOMImplementationFactory;
...
class function CoXMLSchemaCache40.Create: IXMLDOMSchemaCollection;
begin
  Result := CreateComObject(CLASS_XMLSchemaCache40) as IXMLDOMSchemaCollection;
end;

class function CoXMLSchemaCache40.CreateRemote(const MachineName: string): IXMLDOMSchemaCollection;
begin
  Result := CreateRemoteComObject(MachineName, CLASS_XMLSchemaCache40) as IXMLDOMSchemaCollection;
end;
...
class function CoServerXMLHTTP40.Create: IServerXMLHTTPRequest;
begin
  Result := CreateComObject(CLASS_ServerXMLHTTP40) as IServerXMLHTTPRequest;
end;

class function CoServerXMLHTTP40.CreateRemote(const MachineName: string): IServerXMLHTTPRequest;
begin
  Result := CreateRemoteComObject(MachineName, CLASS_ServerXMLHTTP40) as IServerXMLHTTPRequest;
end;
...
class function CoMXNamespaceManager.Create: IMXNamespaceManager;
begin
  Result := CreateComObject(CLASS_MXNamespaceManager) as IMXNamespaceManager;
end;

class function CoMXNamespaceManager.CreateRemote(const MachineName: string): IMXNamespaceManager;
begin
  Result := CreateRemoteComObject(MachineName, CLASS_MXNamespaceManager) as IMXNamespaceManager;
end;

class function CoMXNamespaceManager40.Create: IMXNamespaceManager;
begin
  Result := CreateComObject(CLASS_MXNamespaceManager40) as IMXNamespaceManager;
end;

class function CoMXNamespaceManager40.CreateRemote(const MachineName: string): IMXNamespaceManager;
begin
  Result := CreateRemoteComObject(MachineName, CLASS_MXNamespaceManager40) as IMXNamespaceManager;
end;
...
begin
  Result := TryObjectCreate(
    [CLASS_DOMDocument40, CLASS_DOMDocument30, CLASS_DOMDocument26, CLASS_DOMDocument]) as
    IXMLDOMDocument;
...
initialization
  MSXML4_DOM := TMSDOMImplementationFactory.Create();
  RegisterDOMVendor(MSXML4_DOM);
  MSXMLDOMDocumentCreate := @CreateDOMDocument;

finalization
  UnRegisterDOMVendor(MSXML4_DOM);
  MSXML4_DOM.Free;
