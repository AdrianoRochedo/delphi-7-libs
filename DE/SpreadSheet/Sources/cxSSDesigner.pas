...
uses
  ...
  Grids, StdCtrls, Buttons, ExtCtrls, ComCtrls, cxSSheet,
  cxSSStyles, cxControls, cxGraphics, cxSSCtrls, cxSSColorBox,
  cxSSRes, cxSSPainterWrapper, cxSSTypes, cxExcelConst;
  {$ELSE}
  Qt, QGraphics, QControls, QForms, QTypes, QDialogs, QGrids,
  QStdCtrls, QButtons, QExtCtrls, QComCtrls, Types, QcxControls,
  QcxGraphics, QcxSSheet, QcxSSCtrls, QcxSSColorBox,  QcxSSRes,
  QcxSSPainterWrapper, QcxSSStyles, QcxSSTypes, QcxExcelConst;
  {$ENDIF}
...
{$IFNDEF VCL}
procedure TcxSSStyleDesigner.BtnClick(Sender: TObject);
begin
  ModalResult := (Sender as TComponent).Tag;
  CloseDesigner;
end;
{$ENDIF}
...
begin
  ...
  begin
    ...
    begin
      ...
      DrawText(scxFormatDialogNone2, Rect);
    end
    else
...
begin
  ...
  SetItems(cbxHorzAlign, [scxFormatDialogGeneral, scxFormatDialogLeft,
    scxFormatDialogCenter, scxFormatDialogRight, scxFormatDialogFill,
    scxFormatDialogJustify]);
  SetItems(cbxVertAlign, [scxFormatDialogTop, scxFormatDialogCenter,
    scxFormatDialogBottom, scxFormatDialogJustify]);
  SetCaptions([Self, tbsCellStyle, gbStyle, gbStyleSet, lbStyleDescription, rbGeneral,
    ...
    [scxFormatDialogFormatCaption, scxFormatCellStyle, scxFormatCellStyleType,
    scxFormatStyleStyleSettings, scxGeneralStyleDescription,
    scxFormatStyleGeneral, scxFormatStyleNumber, scxFormatStyleCurrency,
    scxFormatStyleDateTime, scxFormatStyleText, scxFormOk, scxFormCancel, scxFormatDialogFont,
    scxFormatDialogAllBorder, scxFormatDialogTextAlignment, scxFormatDialogTextControl,
    scxFormatDialogItems, scxFormatDialogCellShading, scxFormatDialogWrap,
    scxFormatDialogSample, scxFormatDialogSample, scxFormatDialogLine,
    scxFormatDialogNone, scxFormatDialogOutline, scxFormatDialogInside,
    scxFormatDialogColor, scxFormatDialogPattern, scxFormatDialogStyle,
    scxFormatDialogColor, scxFormatDialogHorzAlign, scxFormatDialogVertAlign,
    scxFormatDialogText, scxFormatDialogBorder, scxFormatDialogPatterns]);
end;
  ...
  try
    ...
    for I := 0 to FHorzCount - 1 do
      ...
      begin
        ...
        FCanvasWrapper.DrawText(scxFormatDialogTextStr, ARect);
      end;
...
begin
  ...
  begin
    ...
    FillRect(Sender.ClientRect, fsSolid,
      GetNativeColor(clBtnFace), GetNativeColor(clBtnFace));
    SelectFont(FontDialog.Font);
    SetTextColor(clBlack);
    CalculateTextExtents(scxFormatDialogSampleText, Sender.ClientRect,
...
const
  Descr: array[0..4] of string = (scxGeneralStyleDescription, scxNumberStyleDescription,
    scxCurrencyStyleDescription, scxDateTimeStyleDescription, scxTextStyleDescription);
var
  AKey: Integer;
begin
  AKey := (Sender as TControl).Tag;
  if not IsLoaded then
    Include(FChangeItems, itStyle);
  lbStyleDescription.Caption := Descr[AKey];
  if AKey in [0, 4] then
