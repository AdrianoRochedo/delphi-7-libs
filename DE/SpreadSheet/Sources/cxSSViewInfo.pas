...
uses
  ...
  {$ELSE}
  Qt, Types, QGraphics, QcxGraphics, QcxExcelConst, QcxSSTypes, QcxSSStyles,
  QcxSSData, QcxSSHeaders, QcxSSFormulas, QcxSSUtils, QcxSSPainterWrapper;
  {$ENDIF}
...
begin
  AValue := 0;
  if ACellRec.Text = '=AVERAGE(H11;H12;H16;H30;H31;H32)' then
     AValue := 0;
  ...
  begin
    ...
    begin
      ...
      begin
        ...
        {$ELSE}
        Canvas.SelectFont(AStyle^.FontPtr^);
        {$ENDIF}
        if AColor = 0 then
