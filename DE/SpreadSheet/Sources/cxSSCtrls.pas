...
uses
  ...
  {$ELSE}
  QTypes, QControls, QStdCtrls, QExtCtrls, QGraphics, Types, QcxSSColorBox;
  {$ENDIF}
...
type
  ...
  protected
    ...
    {$ELSE}
    procedure OnDrawStyleItem(Sender: TObject; Index: Integer; Rect: TRect;
...
procedure TcxSSStyleListBox.OnDrawStyleItem(Control: TWinControl;
  Index: Integer; Rect: TRect; State: TOwnerDrawState);
{$ELSE}
procedure TcxSSStyleListBox.OnDrawStyleItem(Sender: TObject; Index: Integer;
