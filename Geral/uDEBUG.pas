...
type
  ...
  public
    ...
    {
    Procedure WriteFields(Tab: TTable);
    }
    Procedure Values(Const Vals: Array of Const);
...
Procedure TDebug.Write(S: String);
Begin
  Memo.Lines.Add(S);
End;

Procedure TDebug.WriteStrings(SL: TStrings);
var i: Integer;
Begin
  ...
  Memo.Lines.Add('[ END DEBUG ----------------------------------------------------- ]');
  Memo.Lines.Add('');
End;

{
Procedure TDebug.WriteFields(Tab: TTable);
Begin
End;
}

Procedure TDebug.Values(Const Vals: Array of Const);
Var i: Integer;
    O: TObject;
Begin
...
Procedure TDebug.WriteFmt(Const Sfmt: String; Const Values: Array of Const);
Begin
