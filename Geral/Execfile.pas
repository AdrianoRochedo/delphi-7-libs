...
type
  TWindowStyle   = ( wsNorm, wsMinimize, wsMaximize, wsHide, wsMinNoActivate, wsShowNoActivate );
...
procedure Register();
begin
  RegisterComponents('AD-2', [TExecFile]);
end;
...
function TExecFile.ErrorCode: Longword;
begin
  Result := FError;
end;
