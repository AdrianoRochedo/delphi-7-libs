...
begin
  if FMultiSelect and (Msg.lParamLo >= 0) and (Msg.wParamLo <= lHighIndex)
     and (Msg.lParamHi >= 0) and (Msg.wParamHi <= lHighIndex) then begin
...
begin
  if Index < FTopIndex then
    TopIndex := Index
  else if Index+$80000000 > (FTopIndex+Pred(lRows))+$80000000 then begin
