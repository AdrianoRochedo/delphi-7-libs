...
begin
  ...
  if Pos < Len then
    ...
    edMoveCaretTo(edCurLine, edParas.LineLength(edCurLine), Shift)
  else
...
begin
  ...
  edBMGlyphs.Handle := LoadBitMap(HInstance, 'MARKERS');
end;
