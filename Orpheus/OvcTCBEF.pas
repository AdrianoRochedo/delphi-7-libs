  ...
  begin
    if Assigned(Data) then
      begin
        ...
        Move(CopyOfData^, Data^, FEdit.DataSize);
      end;
  end;
{--------}
procedure TOvcTCBaseEntryField.StartEditing(RowNum : TRowNum; ColNum : TColNum;
                                     ...
                                     const CellAttr : TOvcCellAttributes;
                                           ...
                                           Data : pointer);
  begin
    GetMem(CopyOfData, FEdit.DataSize);
    if (Data = nil) then
      FillChar(CopyOfData^, FEdit.DataSize, 0)
    else
      Move(Data^, CopyOfData^, FEdit.DataSize);
...
procedure TOvcTCBaseEntryField.StopEditing(SaveValue : boolean;
  ...
  begin
    ...
    FreeMem(CopyOfData, FEdit.DataSize);
    CopyOfData := nil;
    EditHide;
  end;
{====================================================================}
