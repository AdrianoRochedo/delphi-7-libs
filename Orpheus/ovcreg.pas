...
uses
  ...
  DesignIntf, Classes, Controls, TypInfo,
  OvcData, OvcValid;
...
uses
  (*{$IFDEF NVBUG} LibMain, {$ENDIF}*) {Rochedo}
  ...
  OvcBase, OvcCmd, OvcCmdP0, OvcVer;  {all required}
...
{$IFDEF NVBUG}
  ...
  {OvcBase.ICompLib := LibMain.CompLib;} {Rochedo}
{$ENDIF}
end;
