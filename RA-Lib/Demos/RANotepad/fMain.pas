...
uses
  ...
  ShellApi, RAI2, RACt, ImgList, RAHLEdPropDlg
...
type
  TMain = class(TForm)
    ...
    procedure RAI2Program1SetValue(Sender: TObject; Identifer: String;
...
uses RAUtils, iMTracer,
  ...
  RAI2Fm,
  RAI2_RAEditor, RAI2_RARegAuto, RAI2_RAUtils
  ;
...
begin
  MessageBox('R&A Notepad 2.0 Freeware'#13#13 +
    'Based on Delphi components TRAHLEditor and TRAI2Program.'#13 +
    'Available (free) at R&A Library home page:'#13 +
    '   http://www.infa.ru/black/ralib.htm'#13#13 +
...
begin
  Result := Null;
  if RAI2Script and RAI2Program1.FunctionExists('', FunName) then
    try
...
procedure TMain.RAI2Program1SetValue(Sender: TObject; Identifer: String;
  const Value: Variant; Args: TArgs; var Done: Boolean);
begin
