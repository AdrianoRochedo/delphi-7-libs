...
uses
  ...
  RAHLEdPropDlg, StdCtrls, Buttons, RAButtons, RAEditor, RAHLEditor,
  fRAHLEdPropDlgTestParams, RARegAuto;
...
begin
  ...
  MyParamsForm.Load;
  MyParamsForm.TabSheet1.PageControl := TRAHLEditorParamsForm(Form).Pages;
  MyParamsForm.TabSheet2.PageControl := TRAHLEditorParamsForm(Form).Pages;
